...
typedef enum {
  ...
  SignalErrorCodeMessageStorageInitError = 120,
  SignalErrorCodeCallSafeObjectError = 121,
  SignalErrorCodeMessageErrorCode = 122,
  SignalErrorCodeHttpRequestError = 300,
} SignalErrorCode;
...
typedef struct SignalMessageController SignalMessageController;
...
typedef int (*SignalMessageControllerMessageTest)(void *message_controller_ctx, const char *address, void *ctx);

typedef int (*SignalMessageControllerAccountStatus)(void *message_controller_ctx, int64_t id, int32_t status, void *ctx);

typedef int (*SignalMessageControllerConnectionStatus)(void *message_controller_ctx, int64_t id, int32_t status, void *ctx);

typedef int (*SignalMessageControllerMessageEvent)(const unsigned char *out, size_t out_len, void *message_controller_ctx, int64_t id, void *ctx);

typedef int (*SignalMessageControllerClosed)(void *message_controller_ctx, int64_t id);

typedef int (*SignalMessageControllerMessageStatis)(void *message_controller_ctx, int64_t id, uint8_t data_t, int32_t data_size);

typedef int (*SignalMessageControllerApiTask)(const unsigned char *out, size_t out_len, void *message_controller_ctx, int64_t id, const char *task_id, int32_t error_code);

typedef struct {
  void *ctx;
  SignalMessageControllerMessageTest messageTest;
  SignalMessageControllerAccountStatus onAccountStatus;
  SignalMessageControllerConnectionStatus onConnectionStatus;
  SignalMessageControllerMessageEvent onMessageEvent;
  SignalMessageControllerClosed onClose;
  SignalMessageControllerMessageStatis onMessageStatis;
  SignalMessageControllerApiTask onApiTask;
} SignalMessageControllerDelegateStore;

typedef struct {
  const char *const *base;
  uintptr_t length;
} SignalBorrowedStringArray;

typedef int (*SignalAntHttpRequestCallBackFunction)(void *message_controller_ctx, int32_t id, SignalBorrowedBuffer data, void *ctx);

typedef struct {
  void *ctx;
  SignalAntHttpRequestCallBackFunction callback;
} SignalAntHttpRequestCallBack;

typedef int (*SignalZebraProccessingFunction)(void *ctx, uint64_t offset, uint64_t total);

typedef struct {
  void *ctx;
  SignalZebraProccessingFunction on_proccess;
} SignalIZebraProccessing;

typedef int (*SignalZebraReadDataFunction)(const unsigned char *out, size_t out_len, void *ctx, const char *attachment_id);

typedef int (*SignalZebraReadDataEndFunction)(void *ctx, const char *attachment_id);

typedef struct {
  void *ctx;
  SignalZebraReadDataFunction on_data;
  SignalZebraReadDataEndFunction on_end;
} SignalIReadFileProccessing;
...
SignalFfiError *signal_message_controller_destroy(SignalMessageController *p);

SignalFfiError *signal_message_controller_clone(SignalMessageController **new_obj,
                                                const SignalMessageController *obj);

SignalFfiError *signal_message_controller_get_identity_key_pair(const unsigned char **out,
                                                                size_t *out_len,
                                                                const SignalMessageController *obj);

SignalFfiError *signal_message_controller_get_pni_identity_key_pair(const unsigned char **out,
                                                                    size_t *out_len,
                                                                    const SignalMessageController *obj);

SignalFfiError *signal_message_controller_callmessage(SignalMessageController *controller);

SignalFfiError *signal_message_controller_create_prekeys(const unsigned char **out,
                                                         size_t *out_len,
                                                         const SignalMessageController *controller,
                                                         uint32_t n);

SignalFfiError *signal_message_controller_do_call(const unsigned char **out,
                                                  size_t *out_len,
                                                  const SignalMessageController *controller,
                                                  SignalBorrowedBuffer data);

SignalFfiError *signal_message_controller_create_upload_prekey(const SignalMessageController *controller,
                                                               uint32_t n,
                                                               bool pni);

SignalFfiError *signal_message_get_next_message_id(uint64_t *out);

SignalFfiError *signal_message_get_timestamp(uint64_t *out);

SignalFfiError *signal_message_controller_new(SignalMessageController **out,
                                              int64_t id,
                                              const char *user_id,
                                              const char *pni_id,
                                              int64_t device_id,
                                              int32_t registeration_id,
                                              const SignalMessageControllerDelegateStore *delegate,
                                              const char *db_path_dir,
                                              const char *secert,
                                              const char *ftsExt,
                                              const char *password,
                                              const char *lang,
                                              ...
                                              int32_t client_type,
                                              const char *version,
                                              const char *x_ant_agent,
                                              const char *appid,
                                              int32_t layer,
                                              const char *identity_key,
                                              const char *pni_identity_key,
                                              const char *file_root,
                                              int32_t download_worker,
                                              int32_t upload_worker);

SignalFfiError *signal_init_application(const char *work_path);

SignalFfiError *signal_do_http_request(SignalBorrowedStringArray hosts,
                                       const char *path,
                                       const char *body,
                                       const char *method,
                                       const char *header,
                                       const char *proxies,
                                       const SignalAntHttpRequestCallBack *callback);

SignalFfiError *signal_message_controller_do_http_blocking_request(const unsigned char **out,
                                                                   size_t *out_len,
                                                                   SignalBorrowedStringArray hosts,
                                                                   const char *path,
                                                                   const char *body,
                                                                   const char *method,
                                                                   const char *header,
...
SignalFfiError *signal_message_controller_key_value(const SignalMessageController *controller,
                                                    const char *key,
                                                    SignalBorrowedBuffer data);

SignalFfiError *signal_message_controller_get_keyvalue(const unsigned char **out,
                                                       size_t *out_len,
                                                       const SignalMessageController *controller,
                                                       const char *key);

SignalFfiError *signal_message_controller_get_account_info(const unsigned char **out,
                                                           size_t *out_len,
                                                           const SignalMessageController *controller);

SignalFfiError *signal_message_controller_save_account_info(const SignalMessageController *controller,
                                                            SignalBorrowedBuffer data);

SignalFfiError *signal_message_controller_enabled_proxy(const SignalMessageController *controller,
                                                        const char *proxy);

SignalFfiError *signal_message_controller_disabeld_proxy(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_close(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_start_message(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_start_api(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_start_file_service(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_stop_message(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_stop_api(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_stop_file_service(const SignalMessageController *controller);

SignalFfiError *signal_message_controller_get_server_info(const char **out,
                                                          const SignalMessageController *obj);

SignalFfiError *signal_message_controller_get_get_enabled_proxy_info(const unsigned char **out,
                                                                     size_t *out_len,
                                                                     const SignalMessageController *obj);

SignalFfiError *signal_message_controller_set_server_info(const SignalMessageController *controller,
                                                          const char *server);

SignalFfiError *signal_message_controller_add_task(const unsigned char **out,
                                                   size_t *out_len,
                                                   const SignalMessageController *controller,
                                                   SignalBorrowedBuffer task_data);

SignalFfiError *signal_message_controller_send_text_message(const unsigned char **out,
                                                            size_t *out_len,
                                                            const SignalMessageController *controller,
                                                            const char *text,
                                                            const char *peer_id,
...
SignalFfiError *signal_message_controller_send_data_message(const unsigned char **out,
                                                            size_t *out_len,
                                                            const SignalMessageController *controller,
                                                            SignalBorrowedBuffer data);

SignalFfiError *signal_message_controller_send_edit_data_message(const unsigned char **out,
                                                                 size_t *out_len,
                                                                 const SignalMessageController *controller,
                                                                 SignalBorrowedBuffer data);

SignalFfiError *signal_message_controller_send_forward_data_message(const unsigned char **out,
                                                                    size_t *out_len,
                                                                    const SignalMessageController *controller,
                                                                    SignalBorrowedBuffer data);

SignalFfiError *signal_message_controller_retry_send_message(const unsigned char **out,
                                                             size_t *out_len,
                                                             const SignalMessageController *controller,
                                                             const char *msg_id);

SignalFfiError *signal_message_controller_version_check(const unsigned char **out,
                                                        size_t *out_len,
                                                        const SignalMessageController *controller,
                                                        const char *version,
                                                        const char *dex,
                                                        int32_t channel,
                                                        SignalBorrowedStringArray hosts_str,
                                                        const char *proxies_str,
                                                        bool is_error,
                                                        bool refresh_app);

SignalFfiError *signal_message_version_check(const unsigned char **out,
                                             size_t *out_len,
                                             const char *version,
                                             const char *dex,
                                             int32_t channel,
...
SignalFfiError *signal_message_encrypt_big_file(const unsigned char **out,
                                                size_t *out_len,
                                                SignalBorrowedBuffer key,
                                                SignalBorrowedBuffer hmac_key,
                                                SignalBorrowedBuffer iv,
                                                const char *original_path,
                                                const char *encrypt_path,
                                                const SignalIZebraProccessing *proccess);

SignalFfiError *signal_message_decrypt_big_file(const unsigned char **out,
                                                size_t *out_len,
                                                SignalBorrowedBuffer key,
                                                SignalBorrowedBuffer hmac_key,
                                                const char *encrypt_path,
...
SignalFfiError *signal_message_upload_attachment_part(const char **out,
                                                      SignalBorrowedStringArray hosts,
                                                      const char *attachment_bucket,
                                                      const char *uploader_id,
...
SignalFfiError *signal_message_download_attachment_part(int32_t *out,
                                                        SignalBorrowedStringArray hosts,
                                                        const char *attachment_bucket,
                                                        const char *attachment_id,
                                                        uint64_t offset,
...
SignalFfiError *signal_message_decrypt_read_file(const unsigned char **out,
                                                 size_t *out_len,
                                                 const char *attachment_id,
                                                 SignalBorrowedBuffer key,
                                                 const char *path,
                                                 const SignalIReadFileProccessing *proccess);

SignalFfiError *signal_message_upload_attachment(const char **out,
                                                 SignalBorrowedStringArray hosts,
                                                 const char *attachment_bucket,
                                                 const char *token,
                                                 const char *upload_file,
